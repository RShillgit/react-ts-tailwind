...
export function Navbar() {
    ...
    return (
        <div className="flex justify-between text-lg bg-slate-200 shadow-md p-2">
            ...
            <button className="relative flex items-center justify-center w-10 h-10 border-cyan-400 border-2 rounded-3xl">
                ...
                <div className="text-sm absolute bottom-0 right-0 translate-y-1/3 translate-x-1/3 flex items-center justify-center rounded-full text-white w-5 h-5 bg-red-500">5</div>
            </button>
        </div>
    )
}